...
{
    public class RemoteClientManager : IClientManager
    {
        private readonly NetServer server;

        private readonly Dictionary<long, RemoteClientConnection> connections =
            new Dictionary<long, RemoteClientConnection>();
        ...
        public RemoteClientManager(int port)
        {
        ...
        private void ProcessStatusMessage(NetIncomingMessage msg)
        {
            ...
            switch (status) {
                case NetConnectionStatus.Connected: {
                    ...
                    var connection = new RemoteClientConnection(msg.SenderConnection);
