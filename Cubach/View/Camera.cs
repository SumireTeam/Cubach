...
namespace Cubach.View
{
    ...
    {
        public static readonly float MinFieldOfView = MathHelper.PiOver4;
        public static readonly float MaxFieldOfView = MathHelper.Pi - MathHelper.PiOver6;

        public Vector3 Position { get; set; }
        public Quaternion Orientation { get; set; }

        public float FieldOfViewX = MathHelper.PiOver2;
        ...
        public float FieldOfViewY =>
            Math.Min(Math.Max(MinFieldOfView, FieldOfViewX / Aspect), MaxFieldOfView);
